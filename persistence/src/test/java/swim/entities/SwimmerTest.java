...
public class SwimmerTest extends SQLBasedTest {
	...
	public void testCreateSwimmer() throws SQLException {
		...
		ResultSet rs = statement.executeQuery("SELECT COUNT(*) as total FROM Swimmer WHERE id = " + swimmer.getId());
		rs.next();
	...
	public void testDeleteSwimmer() throws SQLException {
		...
		ResultSet rs = statement.executeQuery("SELECT COUNT(*) as total FROM Swimmer WHERE id = " + id);
		rs.next();
