...
public class ClubTest extends SQLBasedTest {
	...
	public void testCreateClub() throws SQLException {
		...
		ResultSet rs = statement.executeQuery("SELECT COUNT(*) as total FROM Club WHERE id = " + club.getId());
		rs.next();
	...
	public void testFindById() throws SQLException {
		...
		int insertedId = statement.executeUpdate(
				"INSERT INTO Club(name,city,foundationYear) VALUES('ClubName','ClubCity',1999)",
